...
class TTYOutput implements Runnable
{
	...
	private void outputBit(boolean isMark)
	{
		...
		try {
			fAudioWriter.write(fOutputBuffer);
		}
	...
	private File fWavFile;
	private Thread fThread;
	private byte[] fOutputBuffer;
	private double fOutputAngle = 0.0;
	private AudioFileFormat.Type fFileType = AudioFileFormat.Type.WAVE;
	private TTYAudioWriter fAudioWriter;
